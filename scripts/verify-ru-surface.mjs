...
const gateLocalizationExpected = new Map([
  ...
  ['/ru/audit/paid-start-gate', {
    ...
    description: 'Проверка внешних доказательств между принятым предложением аудита и началом работ. Без обработки оплаты, счёта или разрешения на тестирование.'
  }],
